...
<img src="assets/dsa-doctor-logo.svg" alt="DSA Doctor Logo - dsadoctor.com" width="380" />
...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&duration=3000&pause=1000&color=00FF00&center=true&vCenter=true&width=940&lines=%E2%96%B6+Official+Platform%3A+dsadoctor.com+%E2%80%A2+Crack+Interviews+with+Data!;%E2%96%B6+Search+%22dsa+doctor%22+or+%22dsadoctor%22+for+Company-Wise+LeetCode+Prep!;%E2%96%B6+650%2B+Companies+%E2%80%A2+1%2C600%2B+CSV+Datasets+%E2%80%A2+17%2C600%2B+Problems;%E2%96%B6+Filtered+by+Recency%3A+30-Days+%7C+3-Months+%7C+6-Months+%7C+All-Time;%E2%96%B6+Frequency-Ranked+%2B+Pattern-Tagged+%2B+Revision-Prioritized" alt="DSA Doctor Typing SVG Banner - dsadoctor.com" />
  </a>
</p>
...
```mermaid
flowchart TD
    classDef input fill:#0a192f,stroke:#00f5ff,stroke-width:2px,color:#00f5ff;
    classDef filter fill:#0d2040,stroke:#2563eb,stroke-width:2px,color:#7ef9ff;
    classDef strategy fill:#1f1338,stroke:#a855f7,stroke-width:2px,color:#e9d5ff;
    classDef practice fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#a7f3d0;
    classDef outcome fill:#1e293b,stroke:#00FF00,stroke-width:2px,color:#4ade80;

    A["🎯 Step 1: Select Target Company<br/>(e.g., Google, Amazon, Uber, Flipkart)"]:::input --> B{"🕒 Step 2: Select Timeline Horizon"}:::filter
    
    B -->|Interview in < 2 Weeks| C["⚡ thirty-days.csv<br/>(Urgent OA & Onsite Trends)"]:::filter
    B -->|Interview in 1 - 2 Months| D["🔥 three-months.csv / six-months.csv<br/>(High-Frequency Core Pool)"]:::filter
    B -->|Foundational Mastery| E["📚 all.csv<br/>(Complete Historical Problem Bank)"]:::filter
    
    C --> F["📊 Step 3: Sort by Frequency % & Revision Priority"]:::strategy
    D --> F
    E --> F
    
    F --> G["🧩 Step 4: Group by Topic Tags & Patterns<br/>(Sliding Window, Monotonic Stack, BFS/DFS, DP)"]:::strategy
    G --> H["🔁 Step 5: Execute 1-3-7-14 Spaced Repetition"]:::practice
...
<img src="assets/prem-kumar.png" alt="Prem Kumar" width="160" style="border-radius: 50%; box-shadow: 0 4px 20px rgba(0,245,255,0.4);" />

### **Prem Kumar**
*Software Engineer • Full-Stack Developer • Cybersecurity Enthusiast • Creator of DSA Doctor*

<p align="center">
  <a href="https://dsadoctor.com" target="_blank"><img src="https://img.shields.io/badge/Official%20Platform-dsadoctor.com-2563EB?style=for-the-badge&logo=google-chrome&logoColor=white" alt="dsadoctor.com" /></a>
  <a href="https://kali-prem.github.io/Portfolio/" target="_blank"><img src="https://img.shields.io/badge/Portfolio-0d1117?style=for-the-badge&logo=google-chrome&logoColor=white" alt="Portfolio" /></a>
  <a href="https://github.com/Kali-Prem" target="_blank"><img src="https://img.shields.io/badge/GitHub-0d1117?style=for-the-badge&logo=github&logoColor=white" alt="GitHub Profile" /></a>
  <a href="https://www.linkedin.com/in/kali-prem" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Profile" /></a>
  <a href="https://leetcode.com/u/Prem_Kumar01" target="_blank"><img src="https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black" alt="LeetCode Profile" /></a>
